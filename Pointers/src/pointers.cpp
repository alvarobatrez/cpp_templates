...
int main()
{
    ...
    int *p {nullptr}; // point to nowhere
    //int *p = nullptr;
    ...
    cout << "Size of v: " << sizeof(v) << " bytes" << endl << endl;
    ...
    cout << "Value of temp_ptr: " << temp_ptr << endl << endl;
    ...
    *num_ptr = 50;
    ...
    cout << (*beatles_ptr).at(0) << endl;

    for (auto name : *beatles_ptr)
    {
        cout << name << endl;
    }
